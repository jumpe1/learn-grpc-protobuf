...
type Employee struct {
	...
	Project     map[string]*Company_Project `protobuf:"bytes,6,rep,name=project,proto3" json:"project,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // mapにはrepeatedをつけられない
